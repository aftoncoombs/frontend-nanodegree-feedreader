    ...
    */
    ...
    describe('The Menu', function() {
        ...
        it('is hidden by default', function() {
         ...
         it('changes visibility when clicked', function() {
            ...
            // Expect that menu is not open, then click it. Menu should open.
            $('.menu-icon-link').click();
            expect(document.getElementsByTagName('body')[0].className).not.toBe('menu-hidden');
            // Expect that menu is open, then click it. Menu should close.
            $('.menu-icon-link').click();
            expect(document.getElementsByTagName('body')[0].className).toBe('menu-hidden');
         });
    });
    ...
    describe('Initial Entries', function() {
        ...
        it('have at least one entry', function(done) {
            expect(document.getElementsByClassName('feed')[0].childElementCount).not.toBe(0);
            done();
        });
    ...
    describe('New Feed Selection', function() {
        ...
        const priorState = document.getElementsByClassName('feed')[0].childElementCount;
        ...
        it('changes content when a new feed is loaded', function(done) {
            expect(document.getElementsByClassName('feed')[0].childElementCount).not.toBe(priorState);
            done();
        })
    });
}());
